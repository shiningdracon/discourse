...
replaceBBCodeParamsRaw("aname", function(param, contents) {
  return ['a', {'name': param, 'data-bbcode': true}, contents];
});
...
replaceBBCodeParamsRaw("jumpto", function(param, contents) {
  return ['a', {href: "#" + param, 'data-bbcode': true}, contents];
});
